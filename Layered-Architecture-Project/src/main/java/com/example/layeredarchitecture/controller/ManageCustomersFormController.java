...
public class ManageCustomersFormController {
    ...
    public ManageCustomersFormController() throws SQLException, ClassNotFoundException {
    }
        ...
        try {
           /* Connection connection = DBConnection.getDbConnection().getConnection();
            ...
            for (CustomerDTO customerDAOS : customerDTOS){
                tblCustomers.getItems().add(new CustomerTM(customerDAOS.getId(), customerDAOS.getName(), customerDAOS.getAddress()));
            }
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
               ...
               /* Connection connection = DBConnection.getDbConnection().getConnection();
                ...
                customerDAO.saveData(new CustomerDTO(id, name, address));
    ...
    boolean existCustomer(String id) throws SQLException, ClassNotFoundException {
        ...
        boolean idd =customerDAO.getexistID(id);
